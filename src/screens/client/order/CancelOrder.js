...
export default function  CancelOrder() {
    ...
    useEffect(async () => {
        ...
        const dataOrder = await getQueryCollection('order', 'uid_client', 'status', 'Đã Hủy Đơn', uid);
    ...
    const CancelOrder = async (item) => {
        console.log(item);
        await updateData('order', item.id, 'Đã Hủy Đơn')
        ...
        return (
            <List.Accordion
                ...
                <View>
                    ...
                    {/* <View>
                        <Text>{item.order.createDay}</Text>
                    </View> */}
                </View>
            </List.Accordion>
        )
